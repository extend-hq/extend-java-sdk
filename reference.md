                ...
                .schema(
                    new HashMap<String, Object>() {{
                        ...
                        HashMap<String, Object>() {{put("vendor_name", new 
                            ...
                            HashMap<String, Object>() {{put("type", "object");
                                put("extend:type", "currency");
                                put("description", "The total amount due");
                                put("properties", new 
                                HashMap<String, Object>() {{put("amount", new 
                                    HashMap<String, Object>() {{put("type", new ArrayList<Object>(Arrays.asList("number", "null")));
                                    }});
                                    put("iso_4217_currency_code", new 
                                    HashMap<String, Object>() {{put("type", new ArrayList<Object>(Arrays.asList("string", "null")));
                                    }});
                                }});
                                put("required", new ArrayList<Object>(Arrays.asList("amount", "iso_4217_currency_code")));
                            }});
                        }});
                    }}
                )
...
**source:** `Optional<ParseRunSource>` 
...
## EditTemplates
<details><summary><code>client.editTemplates.retrieve(id) -> EditTemplate</code></summary>
<dl>
<dd>
...
client.editSchemas().generate(
    EditSchemasGenerateRequest
        .builder()
        .file(
            EditSchemasGenerateRequestFile.of(
                FileFromUrl
                    .builder()
                    .url("https://example.com/form.pdf")
                    .build()
...
**file:** `EditSchemasGenerateRequestFile` — The file to analyze. Files can be provided as a URL or an Extend file ID.
...
## Workflows
<details><summary><code>client.workflows.list() -> WorkflowsListResponse</code></summary>
<dl>
<dd>
...
**steps:** `Optional<List<WorkflowStepDefinition>>` 
...
<details><summary><code>client.workflows.retrieve(id) -> Workflow</code></summary>
<dl>
<dd>
...
```java
client.workflows().retrieve("workflow_abc123");
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.workflows.update(id, request) -> Workflow</code></summary>
<dl>
<dd>
...
**name:** `Optional<String>` — The new name for the workflow.
...
## WorkflowVersions
<details><summary><code>client.workflowVersions.list(id) -> WorkflowVersionsListResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.workflowVersions.create(id, request) -> WorkflowVersion</code></summary>
<dl>
<dd>
...
**name:** `Optional<String>` — An optional name for this deployed version.
...
<details><summary><code>client.workflowVersions.retrieve(id, versionId) -> WorkflowVersion</code></summary>
<dl>
<dd>
...
```java
client.workflowVersions().retrieve("workflow_abc123", "draft");
```
</dd>
</dl>
</dd>
...
**file:** `Optional<LegacyProcessorRunFileInput>` — The file to be processed. One of `file` or `rawText` must be provided. Supported file types can be found [here](https://docs.extend.ai/2026-02-09/general/supported-file-types).
...
client.evaluationSetItems().retrieve(
    ...
    EvaluationSetItemsRetrieveRequest
        .builder()
        .build()
);
```
...
client.evaluationSetItems().delete(
    "evaluation_set_id_here",
    "evaluation_set_item_id_here",
    EvaluationSetItemsDeleteRequest
        .builder()
        .build()
);
```
...
client.evaluationSetRuns().retrieve(
    ...
    EvaluationSetRunsRetrieveRequest
        .builder()
        .build()
);
```
...
client.webhookEndpoints().retrieve(
    ...
    WebhookEndpointsRetrieveRequest
        .builder()
        .build()
);
```
...
client.webhookSubscriptions().retrieve(
    ...
    WebhookSubscriptionsRetrieveRequest
        .builder()
        .build()
);
```
...
client.webhookSubscriptions().delete(
    "webhook_subscription_id_here",
    WebhookSubscriptionsDeleteRequest
        .builder()
        .build()
);
```
