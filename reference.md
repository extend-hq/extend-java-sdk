# Reference
<details><summary><code>client.createFile(request) -> PostFilesResponse</code></summary>
<dl>
<dd>
...
**url:** `Optional<String>` — A pre signed URL for the file
...
**rawText:** `Optional<String>` — The raw text content of the file
...
**mediaType:** `Optional<String>` — The media type of the file (e.g. application/pdf)
