...
@JsonDeserialize(builder = ExtractOptimizerOptions.Builder.class)
public final class ExtractOptimizerOptions {
    ...
    private ExtractOptimizerOptions(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractOptimizerOptions && equalTo((ExtractOptimizerOptions) other);
    }
    ...
    private boolean equalTo(ExtractOptimizerOptions other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExtractOptimizerOptions other) {
        ...
        public ExtractOptimizerOptions build() {
            return new ExtractOptimizerOptions(accuracyThreshold, maxBatchRuns, additionalProperties);
        }
    }
}
