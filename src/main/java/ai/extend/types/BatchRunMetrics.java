...
@JsonDeserialize(builder = BatchRunMetrics.Builder.class)
public final class BatchRunMetrics {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BatchRunMetrics && equalTo((BatchRunMetrics) other);
    }
    ...
    private boolean equalTo(BatchRunMetrics other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BatchRunMetrics other) {
        ...
        public BatchRunMetrics build() {
            return new BatchRunMetrics(numFiles, numPages, additionalProperties);
        }
    }
}
