...
@JsonDeserialize(builder = LegacyBatchProcessorRunMetrics.Builder.class)
public final class LegacyBatchProcessorRunMetrics {
    ...
    private LegacyBatchProcessorRunMetrics(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyBatchProcessorRunMetrics && equalTo((LegacyBatchProcessorRunMetrics) other);
    }
    ...
    private boolean equalTo(LegacyBatchProcessorRunMetrics other) {
    ...
    public static final class Builder {
        ...
        public Builder from(LegacyBatchProcessorRunMetrics other) {
        ...
        public LegacyBatchProcessorRunMetrics build() {
            return new LegacyBatchProcessorRunMetrics(numFiles, numPages, additionalProperties);
        }
    }
}
