...
@JsonDeserialize(builder = ExtractorVersion.Builder.class)
public final class ExtractorVersion {
     ...
     * <ul>
     * <li><strong><a href="https://docs.extend.ai/2026-02-09/extraction/schema">JSON Schema config</a>:</strong> The current config format. All extractors created through this API version use this shape.</li>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractorVersion && equalTo((ExtractorVersion) other);
    }
    ...
    private boolean equalTo(ExtractorVersion other) {
    ...
    public interface IdStage {
        ...
        Builder from(ExtractorVersion other);
    }
    ...
    public static final class Builder
            implements IdStage, VersionStage, ConfigStage, ExtractorIdStage, CreatedAtStage, _FinalStage {
        private String id;
        ...
        @java.lang.Override
        public Builder from(ExtractorVersion other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("config")
        public ExtractorIdStage config(@NotNull ExtractConfig config) {
