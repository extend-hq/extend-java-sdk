...
public final class OptimizerBatchProcessorRunResultProcessorConfig {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private OptimizerBatchProcessorRunResultProcessorConfig(Value value) {
        this.value = value;
    }
    ...
    public static OptimizerBatchProcessorRunResultProcessorConfig extract(ExtractionConfig value) {
        return new OptimizerBatchProcessorRunResultProcessorConfig(new ExtractValue(value));
    }

    public static OptimizerBatchProcessorRunResultProcessorConfig classify(ClassificationConfig value) {
        return new OptimizerBatchProcessorRunResultProcessorConfig(new ClassifyValue(value));
    }
    ...
    @JsonSubTypes({@JsonSubTypes.Type(ExtractValue.class), @JsonSubTypes.Type(ClassifyValue.class)})
    ...
    private static final class ExtractValue implements Value {
        ...
        public String toString() {
            return "OptimizerBatchProcessorRunResultProcessorConfig{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "OptimizerBatchProcessorRunResultProcessorConfig{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
