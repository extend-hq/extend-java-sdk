...
@JsonDeserialize(builder = LegacyClassificationAdvancedOptions.Builder.class)
public final class LegacyClassificationAdvancedOptions {
    private final Optional<LegacyClassificationAdvancedOptionsContext> context;
    ...
    private LegacyClassificationAdvancedOptions(
            Optional<LegacyClassificationAdvancedOptionsContext> context,
    ...
    public Optional<LegacyClassificationAdvancedOptionsContext> getContext() {
        return context;
    }
    ...
    /**
     * @return Limit processing to a specific number of pages from the beginning of the document. See <a href="https://docs.extend.ai/2026-02-09/page-ranges">Page Ranges</a>.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyClassificationAdvancedOptions
                && equalTo((LegacyClassificationAdvancedOptions) other);
    }
    ...
    private boolean equalTo(LegacyClassificationAdvancedOptions other) {
    ...
    public static final class Builder {
        private Optional<LegacyClassificationAdvancedOptionsContext> context = Optional.empty();
        ...
        public Builder from(LegacyClassificationAdvancedOptions other) {
        ...
        public Builder context(Optional<LegacyClassificationAdvancedOptionsContext> context) {
            this.context = context;
            return this;
        }

        public Builder context(LegacyClassificationAdvancedOptionsContext context) {
        ...
        /**
         * <p>Limit processing to a specific number of pages from the beginning of the document. See <a href="https://docs.extend.ai/2026-02-09/page-ranges">Page Ranges</a>.</p>
         */
        ...
        public LegacyClassificationAdvancedOptions build() {
            return new LegacyClassificationAdvancedOptions(
