...
@JsonDeserialize(builder = LegacyJsonOutputMetadataValueCitationsItem.Builder.class)
public final class LegacyJsonOutputMetadataValueCitationsItem {
    private final Optional<Double> page;

    private final Optional<String> referenceText;

    private final Optional<List<LegacyJsonOutputMetadataValueCitationsItemPolygonItem>> polygon;
    ...
    private LegacyJsonOutputMetadataValueCitationsItem(
            Optional<Double> page,
            Optional<String> referenceText,
            Optional<List<LegacyJsonOutputMetadataValueCitationsItemPolygonItem>> polygon,
    ...
    public Optional<List<LegacyJsonOutputMetadataValueCitationsItemPolygonItem>> getPolygon() {
        return polygon;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyJsonOutputMetadataValueCitationsItem
                && equalTo((LegacyJsonOutputMetadataValueCitationsItem) other);
    }
    ...
    private boolean equalTo(LegacyJsonOutputMetadataValueCitationsItem other) {
    ...
    public static final class Builder {
        ...
        private Optional<List<LegacyJsonOutputMetadataValueCitationsItemPolygonItem>> polygon = Optional.empty();
        ...
        public Builder from(LegacyJsonOutputMetadataValueCitationsItem other) {
            page(other.getPage());
        ...
        public Builder polygon(Optional<List<LegacyJsonOutputMetadataValueCitationsItemPolygonItem>> polygon) {
            this.polygon = polygon;
            return this;
        }

        public Builder polygon(List<LegacyJsonOutputMetadataValueCitationsItemPolygonItem> polygon) {
        ...
        public LegacyJsonOutputMetadataValueCitationsItem build() {
            return new LegacyJsonOutputMetadataValueCitationsItem(
