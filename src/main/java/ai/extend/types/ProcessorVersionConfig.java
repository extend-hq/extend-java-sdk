...
public final class ProcessorVersionConfig {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ProcessorVersionConfig(Value value) {
        this.value = value;
    }
    ...
    public static ProcessorVersionConfig classify(ClassificationConfig value) {
        return new ProcessorVersionConfig(new ClassifyValue(value));
    }

    public static ProcessorVersionConfig extract(ExtractionConfig value) {
        return new ProcessorVersionConfig(new ExtractValue(value));
    }

    public static ProcessorVersionConfig splitter(SplitterConfig value) {
        return new ProcessorVersionConfig(new SplitterValue(value));
    }
    ...
    private static final class ClassifyValue implements Value {
        ...
        public String toString() {
            return "ProcessorVersionConfig{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ProcessorVersionConfig{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
