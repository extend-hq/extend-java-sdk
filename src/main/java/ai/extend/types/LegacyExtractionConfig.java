...
@JsonDeserialize(builder = LegacyExtractionConfig.Builder.class)
public final class LegacyExtractionConfig {
    private final Optional<LegacyExtractionConfigBaseProcessor> baseProcessor;
    ...
    private final Optional<List<LegacyExtractionField>> fields;

    private final Optional<LegacyExtractionAdvancedOptions> advancedOptions;

    private final Optional<ParseConfig> parser;

    private final Map<String, Object> additionalProperties;

    private LegacyExtractionConfig(
            Optional<LegacyExtractionConfigBaseProcessor> baseProcessor,
            Optional<String> baseVersion,
            Optional<String> extractionRules,
            Optional<Map<String, Object>> schema,
            Optional<List<LegacyExtractionField>> fields,
            Optional<LegacyExtractionAdvancedOptions> advancedOptions,
    ...
    /**
     * @return The base processor to use. For extractors, this must be either <code>&quot;extraction_performance&quot;</code> or <code>&quot;extraction_light&quot;</code>. See <a href="https://docs.extend.ai/2026-02-09/model-versioning/extraction/extraction-performance">Extraction Changelog</a> for more details.
     */
     ...
     */
    @JsonProperty("fields")
    public Optional<List<LegacyExtractionField>> getFields() {
        return fields;
    }
    ...
    public Optional<LegacyExtractionAdvancedOptions> getAdvancedOptions() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyExtractionConfig && equalTo((LegacyExtractionConfig) other);
    }
    ...
    private boolean equalTo(LegacyExtractionConfig other) {
    ...
    public static final class Builder {
        private Optional<LegacyExtractionConfigBaseProcessor> baseProcessor = Optional.empty();
        ...
        private Optional<List<LegacyExtractionField>> fields = Optional.empty();

        private Optional<LegacyExtractionAdvancedOptions> advancedOptions = Optional.empty();
        ...
        public Builder from(LegacyExtractionConfig other) {
        ...
        /**
         * <p>The base processor to use. For extractors, this must be either <code>&quot;extraction_performance&quot;</code> or <code>&quot;extraction_light&quot;</code>. See <a href="https://docs.extend.ai/2026-02-09/model-versioning/extraction/extraction-performance">Extraction Changelog</a> for more details.</p>
         */
        ...
        public Builder baseProcessor(LegacyExtractionConfigBaseProcessor baseProcessor) {
        ...
        public Builder fields(Optional<List<LegacyExtractionField>> fields) {
            this.fields = fields;
            return this;
        }

        public Builder fields(List<LegacyExtractionField> fields) {
        ...
        public Builder advancedOptions(Optional<LegacyExtractionAdvancedOptions> advancedOptions) {
            this.advancedOptions = advancedOptions;
            return this;
        }

        public Builder advancedOptions(LegacyExtractionAdvancedOptions advancedOptions) {
        ...
        public LegacyExtractionConfig build() {
            return new LegacyExtractionConfig(
                    baseProcessor,
                    baseVersion,
                    extractionRules,
                    schema,
