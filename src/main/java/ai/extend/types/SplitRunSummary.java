...
@JsonDeserialize(builder = SplitRunSummary.Builder.class)
public final class SplitRunSummary {
    ...
    /**
     * @return Usage credits consumed by this split run. Omits <code>breakdown</code> — fetch the full split run by id to see the per-line items.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SplitRunSummary && equalTo((SplitRunSummary) other);
    }
    ...
    private boolean equalTo(SplitRunSummary other) {
    ...
    public interface IdStage {
        ...
        Builder from(SplitRunSummary other);
    }
    ...
    public interface _FinalStage {
        ...
        /**
         * <p>Usage credits consumed by this split run. Omits <code>breakdown</code> — fetch the full split run by id to see the per-line items.</p>
         * <p><strong>Availability:</strong> Present when <code>status</code> is <code>&quot;PROCESSED&quot;</code>. Will not be returned for runs created before October 7, 2025 or for customers on legacy billing systems.</p>
         */
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public Builder from(SplitRunSummary other) {
            id(other.getId());
        ...
        @java.lang.Override
        public SplitRunSummary build() {
            return new SplitRunSummary(
                    id,
                    splitter,
                    splitterVersion,
                    status,
