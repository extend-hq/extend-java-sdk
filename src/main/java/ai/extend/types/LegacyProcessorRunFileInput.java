...
@JsonDeserialize(builder = LegacyProcessorRunFileInput.Builder.class)
public final class LegacyProcessorRunFileInput {
    ...
    private LegacyProcessorRunFileInput(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyProcessorRunFileInput && equalTo((LegacyProcessorRunFileInput) other);
    }
    ...
    private boolean equalTo(LegacyProcessorRunFileInput other) {
    ...
    public static final class Builder {
        ...
        public Builder from(LegacyProcessorRunFileInput other) {
        ...
        public LegacyProcessorRunFileInput build() {
            return new LegacyProcessorRunFileInput(fileName, fileUrl, fileId, additionalProperties);
        }
    }
}
