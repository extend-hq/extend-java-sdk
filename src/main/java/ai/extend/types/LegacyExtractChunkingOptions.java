...
@JsonDeserialize(builder = LegacyExtractChunkingOptions.Builder.class)
public final class LegacyExtractChunkingOptions {
    private final Optional<LegacyExtractChunkingOptionsChunkingStrategy> chunkingStrategy;

    private final Optional<Integer> pageChunkSize;

    private final Optional<LegacyExtractChunkingOptionsChunkSelectionStrategy> chunkSelectionStrategy;

    private final Optional<String> customSemanticChunkingRules;

    private final Map<String, Object> additionalProperties;

    private LegacyExtractChunkingOptions(
            Optional<LegacyExtractChunkingOptionsChunkingStrategy> chunkingStrategy,
            Optional<Integer> pageChunkSize,
            Optional<LegacyExtractChunkingOptionsChunkSelectionStrategy> chunkSelectionStrategy,
    ...
    public Optional<LegacyExtractChunkingOptionsChunkingStrategy> getChunkingStrategy() {
    ...
    public Optional<LegacyExtractChunkingOptionsChunkSelectionStrategy> getChunkSelectionStrategy() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyExtractChunkingOptions && equalTo((LegacyExtractChunkingOptions) other);
    }
    ...
    private boolean equalTo(LegacyExtractChunkingOptions other) {
    ...
    public static final class Builder {
        private Optional<LegacyExtractChunkingOptionsChunkingStrategy> chunkingStrategy = Optional.empty();

        private Optional<Integer> pageChunkSize = Optional.empty();

        private Optional<LegacyExtractChunkingOptionsChunkSelectionStrategy> chunkSelectionStrategy = Optional.empty();
        ...
        public Builder from(LegacyExtractChunkingOptions other) {
        ...
        public Builder chunkingStrategy(Optional<LegacyExtractChunkingOptionsChunkingStrategy> chunkingStrategy) {
            this.chunkingStrategy = chunkingStrategy;
            return this;
        }

        public Builder chunkingStrategy(LegacyExtractChunkingOptionsChunkingStrategy chunkingStrategy) {
        ...
        public Builder chunkSelectionStrategy(
                LegacyExtractChunkingOptionsChunkSelectionStrategy chunkSelectionStrategy) {
        ...
        public LegacyExtractChunkingOptions build() {
            return new LegacyExtractChunkingOptions(
                    chunkingStrategy,
                    pageChunkSize,
