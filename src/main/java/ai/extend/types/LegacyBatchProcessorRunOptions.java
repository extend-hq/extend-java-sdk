...
@JsonDeserialize(builder = LegacyBatchProcessorRunOptions.Builder.class)
public final class LegacyBatchProcessorRunOptions {
    ...
    private LegacyBatchProcessorRunOptions(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyBatchProcessorRunOptions && equalTo((LegacyBatchProcessorRunOptions) other);
    }
    ...
    private boolean equalTo(LegacyBatchProcessorRunOptions other) {
    ...
    public static final class Builder {
        ...
        public Builder from(LegacyBatchProcessorRunOptions other) {
        ...
        public LegacyBatchProcessorRunOptions build() {
            return new LegacyBatchProcessorRunOptions(fuzzyMatchFields, excludeFields, additionalProperties);
        }
    }
}
