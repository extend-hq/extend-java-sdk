...
@JsonDeserialize(builder = LegacyExtendError.Builder.class)
public final class LegacyExtendError {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LegacyExtendError && equalTo((LegacyExtendError) other);
    }
    ...
    private boolean equalTo(LegacyExtendError other) {
    ...
    public interface CodeStage {
        ...
        Builder from(LegacyExtendError other);
    }
    ...
    public static final class Builder implements CodeStage, MessageStage, RequestIdStage, RetryableStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(LegacyExtendError other) {
            code(other.getCode());
        ...
        @java.lang.Override
        public LegacyExtendError build() {
            return new LegacyExtendError(code, message, requestId, retryable, additionalProperties);
        }
    }
}
