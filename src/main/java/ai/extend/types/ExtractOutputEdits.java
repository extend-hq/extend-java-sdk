...
@JsonDeserialize(builder = ExtractOutputEdits.Builder.class)
public final class ExtractOutputEdits {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractOutputEdits && equalTo((ExtractOutputEdits) other);
    }
    ...
    private boolean equalTo(ExtractOutputEdits other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExtractOutputEdits other) {
        ...
        public ExtractOutputEdits build() {
            return new ExtractOutputEdits(originalValue, editedValue, notes, page, fieldType, additionalProperties);
        }
    }
}
