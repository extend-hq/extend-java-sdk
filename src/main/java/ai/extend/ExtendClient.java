...
public class ExtendClient {
     ...
     */
    public PostFilesResponse createFile(PostFilesRequest request) {
     ...
     * Create a new file in Extend for use in an evaluation set. This endpoint is deprecated, use /files/upload instead.
     */
    public PostFilesResponse createFile(PostFilesRequest request, RequestOptions requestOptions) {
