...
@JsonDeserialize(builder = WorkflowRunGetRequest.Builder.class)
public final class WorkflowRunGetRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WorkflowRunGetRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkflowRunGetRequest && equalTo((WorkflowRunGetRequest) other);
    }
    ...
    private boolean equalTo(WorkflowRunGetRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WorkflowRunGetRequest other) {
        ...
        public WorkflowRunGetRequest build() {
            return new WorkflowRunGetRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
