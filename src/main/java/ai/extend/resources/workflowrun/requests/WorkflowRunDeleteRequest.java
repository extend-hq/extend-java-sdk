...
@JsonDeserialize(builder = WorkflowRunDeleteRequest.Builder.class)
public final class WorkflowRunDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WorkflowRunDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkflowRunDeleteRequest && equalTo((WorkflowRunDeleteRequest) other);
    }
    ...
    private boolean equalTo(WorkflowRunDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WorkflowRunDeleteRequest other) {
        ...
        public WorkflowRunDeleteRequest build() {
            return new WorkflowRunDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
