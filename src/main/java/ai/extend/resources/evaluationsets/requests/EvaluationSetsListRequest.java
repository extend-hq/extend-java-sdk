...
public final class EvaluationSetsListRequest {
    ...
    public int hashCode() {
        return Objects.hash(
                this.extendWorkspaceId, this.entityId, this.sortBy, this.sortDir, this.nextPageToken, this.maxPageSize);
    }
    ...
    public static final class Builder {
        ...
        public EvaluationSetsListRequest build() {
            return new EvaluationSetsListRequest(
                    extendWorkspaceId, entityId, sortBy, sortDir, nextPageToken, maxPageSize, additionalProperties);
        }
    }
}
