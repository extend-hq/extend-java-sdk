...
@JsonDeserialize(builder = EvaluationSetsRetrieveRequest.Builder.class)
public final class EvaluationSetsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EvaluationSetsRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EvaluationSetsRetrieveRequest && equalTo((EvaluationSetsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(EvaluationSetsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EvaluationSetsRetrieveRequest other) {
        ...
        public EvaluationSetsRetrieveRequest build() {
            return new EvaluationSetsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
