...
@JsonDeserialize(builder = EditDeleteRequest.Builder.class)
public final class EditDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EditDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EditDeleteRequest && equalTo((EditDeleteRequest) other);
    }
    ...
    private boolean equalTo(EditDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EditDeleteRequest other) {
        ...
        public EditDeleteRequest build() {
            return new EditDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
