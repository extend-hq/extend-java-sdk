...
@JsonDeserialize(builder = EditGetRequest.Builder.class)
public final class EditGetRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EditGetRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EditGetRequest && equalTo((EditGetRequest) other);
    }
    ...
    private boolean equalTo(EditGetRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EditGetRequest other) {
        ...
        public EditGetRequest build() {
            return new EditGetRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
