...
@JsonDeserialize(builder = EditCreateAsyncRequestFile.Builder.class)
public final class EditCreateAsyncRequestFile {
    ...
    private EditCreateAsyncRequestFile(
    ...
    /**
     * @return If you already have an Extend file id (for instance from running a workflow or a previous file upload) then you can use that file id when running the edit endpoint. The file id will start with &quot;file_&quot;. One of <code>fileUrl</code> or <code>fileId</code> must be provided.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EditCreateAsyncRequestFile && equalTo((EditCreateAsyncRequestFile) other);
    }
    ...
    private boolean equalTo(EditCreateAsyncRequestFile other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EditCreateAsyncRequestFile other) {
        ...
        /**
         * <p>If you already have an Extend file id (for instance from running a workflow or a previous file upload) then you can use that file id when running the edit endpoint. The file id will start with &quot;file_&quot;. One of <code>fileUrl</code> or <code>fileId</code> must be provided.</p>
         * <p>Example: <code>&quot;file_xK9mLPqRtN3vS8wF5hB2cQ&quot;</code></p>
         */
        ...
        public EditCreateAsyncRequestFile build() {
            return new EditCreateAsyncRequestFile(fileName, fileUrl, fileId, additionalProperties);
        }
    }
}
