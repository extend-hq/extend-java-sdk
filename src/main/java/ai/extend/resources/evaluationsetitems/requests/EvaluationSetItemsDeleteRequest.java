...
@JsonDeserialize(builder = EvaluationSetItemsDeleteRequest.Builder.class)
public final class EvaluationSetItemsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EvaluationSetItemsDeleteRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EvaluationSetItemsDeleteRequest && equalTo((EvaluationSetItemsDeleteRequest) other);
    }
    ...
    private boolean equalTo(EvaluationSetItemsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EvaluationSetItemsDeleteRequest other) {
        ...
        public EvaluationSetItemsDeleteRequest build() {
            return new EvaluationSetItemsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
