...
@JsonDeserialize(builder = EvaluationSetItemsRetrieveRequest.Builder.class)
public final class EvaluationSetItemsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EvaluationSetItemsRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EvaluationSetItemsRetrieveRequest && equalTo((EvaluationSetItemsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(EvaluationSetItemsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EvaluationSetItemsRetrieveRequest other) {
        ...
        public EvaluationSetItemsRetrieveRequest build() {
            return new EvaluationSetItemsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
