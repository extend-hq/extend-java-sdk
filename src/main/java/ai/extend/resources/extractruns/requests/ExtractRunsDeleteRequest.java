...
@JsonDeserialize(builder = ExtractRunsDeleteRequest.Builder.class)
public final class ExtractRunsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ExtractRunsDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractRunsDeleteRequest && equalTo((ExtractRunsDeleteRequest) other);
    }
    ...
    private boolean equalTo(ExtractRunsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExtractRunsDeleteRequest other) {
        ...
        public ExtractRunsDeleteRequest build() {
            return new ExtractRunsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
