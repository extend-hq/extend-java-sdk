...
@JsonDeserialize(builder = ExtractRunsCancelRequest.Builder.class)
public final class ExtractRunsCancelRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ExtractRunsCancelRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractRunsCancelRequest && equalTo((ExtractRunsCancelRequest) other);
    }
    ...
    private boolean equalTo(ExtractRunsCancelRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExtractRunsCancelRequest other) {
        ...
        public ExtractRunsCancelRequest build() {
            return new ExtractRunsCancelRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
