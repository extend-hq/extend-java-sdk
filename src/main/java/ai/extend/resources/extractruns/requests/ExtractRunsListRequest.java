...
@JsonDeserialize(builder = ExtractRunsListRequest.Builder.class)
public final class ExtractRunsListRequest {
    private final Optional<ProcessorRunStatus> status;

    private final Optional<String> extractorId;
    ...
    private ExtractRunsListRequest(
            Optional<ProcessorRunStatus> status,
            Optional<String> extractorId,
    ...
    /**
     * @return Filters extract runs by the extractor ID. If not provided, all extract runs are returned.
     * <p>Example: <code>&quot;ex_BMdfq_yWM3sT-ZzvCnA3f&quot;</code></p>
     */
    @JsonProperty("extractorId")
    public Optional<String> getExtractorId() {
        return extractorId;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractRunsListRequest && equalTo((ExtractRunsListRequest) other);
    }
    ...
    private boolean equalTo(ExtractRunsListRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<String> extractorId = Optional.empty();
        ...
        public Builder from(ExtractRunsListRequest other) {
        ...
        /**
         * <p>Filters extract runs by the extractor ID. If not provided, all extract runs are returned.</p>
         * <p>Example: <code>&quot;ex_BMdfq_yWM3sT-ZzvCnA3f&quot;</code></p>
         */
        @JsonSetter(value = "extractorId", nulls = Nulls.SKIP)
        public Builder extractorId(Optional<String> extractorId) {
            this.extractorId = extractorId;
            return this;
        }

        public Builder extractorId(String extractorId) {
            this.extractorId = Optional.ofNullable(extractorId);
            return this;
        }
        ...
        public ExtractRunsListRequest build() {
            return new ExtractRunsListRequest(
                    status,
                    extractorId,
                    sourceId,
                    source,
