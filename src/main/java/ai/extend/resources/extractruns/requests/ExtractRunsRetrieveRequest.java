...
@JsonDeserialize(builder = ExtractRunsRetrieveRequest.Builder.class)
public final class ExtractRunsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ExtractRunsRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractRunsRetrieveRequest && equalTo((ExtractRunsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(ExtractRunsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExtractRunsRetrieveRequest other) {
        ...
        public ExtractRunsRetrieveRequest build() {
            return new ExtractRunsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
