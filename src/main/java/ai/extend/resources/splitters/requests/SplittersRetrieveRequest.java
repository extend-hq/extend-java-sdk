...
@JsonDeserialize(builder = SplittersRetrieveRequest.Builder.class)
public final class SplittersRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private SplittersRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SplittersRetrieveRequest && equalTo((SplittersRetrieveRequest) other);
    }
    ...
    private boolean equalTo(SplittersRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SplittersRetrieveRequest other) {
        ...
        public SplittersRetrieveRequest build() {
            return new SplittersRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
