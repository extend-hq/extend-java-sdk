...
@JsonDeserialize(builder = ProcessorVersionGetRequest.Builder.class)
public final class ProcessorVersionGetRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ProcessorVersionGetRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProcessorVersionGetRequest && equalTo((ProcessorVersionGetRequest) other);
    }
    ...
    private boolean equalTo(ProcessorVersionGetRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ProcessorVersionGetRequest other) {
        ...
        public ProcessorVersionGetRequest build() {
            return new ProcessorVersionGetRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
