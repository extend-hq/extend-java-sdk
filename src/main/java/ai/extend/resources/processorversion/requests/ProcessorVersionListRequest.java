...
@JsonDeserialize(builder = ProcessorVersionListRequest.Builder.class)
public final class ProcessorVersionListRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ProcessorVersionListRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProcessorVersionListRequest && equalTo((ProcessorVersionListRequest) other);
    }
    ...
    private boolean equalTo(ProcessorVersionListRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ProcessorVersionListRequest other) {
        ...
        public ProcessorVersionListRequest build() {
            return new ProcessorVersionListRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
