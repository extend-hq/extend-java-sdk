...
public final class ProcessorVersionCreateRequestConfig {
    ...
    public static ProcessorVersionCreateRequestConfig classify(LegacyClassificationConfig value) {
        return new ProcessorVersionCreateRequestConfig(new ClassifyValue(value));
    }

    public static ProcessorVersionCreateRequestConfig extract(LegacyExtractionConfig value) {
        return new ProcessorVersionCreateRequestConfig(new ExtractValue(value));
    }

    public static ProcessorVersionCreateRequestConfig splitter(LegacySplitterConfig value) {
