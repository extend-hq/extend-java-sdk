...
public class AsyncRawWebhookSubscriptionsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawWebhookSubscriptionsClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<ExtendClientHttpResponse<WebhookSubscriptionsListResponse>> list(
        ...
        if (request.getWebhookEndpointId().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "webhookEndpointId", request.getWebhookEndpointId().get(), false);
        }
        if (request.getResourceId().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "resourceId", request.getResourceId().get(), false);
        }
