...
@JsonDeserialize(builder = WebhookSubscriptionsDeleteRequest.Builder.class)
public final class WebhookSubscriptionsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WebhookSubscriptionsDeleteRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WebhookSubscriptionsDeleteRequest && equalTo((WebhookSubscriptionsDeleteRequest) other);
    }
    ...
    private boolean equalTo(WebhookSubscriptionsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WebhookSubscriptionsDeleteRequest other) {
        ...
        public WebhookSubscriptionsDeleteRequest build() {
            return new WebhookSubscriptionsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
