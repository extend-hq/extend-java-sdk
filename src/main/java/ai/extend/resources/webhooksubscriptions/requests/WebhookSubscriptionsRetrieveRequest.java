...
@JsonDeserialize(builder = WebhookSubscriptionsRetrieveRequest.Builder.class)
public final class WebhookSubscriptionsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WebhookSubscriptionsRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WebhookSubscriptionsRetrieveRequest
                && equalTo((WebhookSubscriptionsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(WebhookSubscriptionsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WebhookSubscriptionsRetrieveRequest other) {
        ...
        public WebhookSubscriptionsRetrieveRequest build() {
            return new WebhookSubscriptionsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
