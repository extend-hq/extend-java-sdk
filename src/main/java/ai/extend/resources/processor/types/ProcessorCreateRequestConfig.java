...
public final class ProcessorCreateRequestConfig {
    ...
    public static ProcessorCreateRequestConfig classify(LegacyClassificationConfig value) {
        return new ProcessorCreateRequestConfig(new ClassifyValue(value));
    }

    public static ProcessorCreateRequestConfig extract(LegacyExtractionConfig value) {
        return new ProcessorCreateRequestConfig(new ExtractValue(value));
    }

    public static ProcessorCreateRequestConfig splitter(LegacySplitterConfig value) {
