...
public class AsyncBatchWorkflowRunClient {
     ...
     * <p>Unlike the single <a href="https://docs.extend.ai/2025-04-21/developers/api-reference/workflow-endpoints/run-workflow">Run Workflow</a> endpoint which returns the details of the created workflow runs immediately, this batch endpoint returns a <code>batchId</code>.</p>
     * <p>Our recommended usage pattern is to integrate with <a href="https://docs.extend.ai/2025-04-21/product/webhooks/configuration">Webhooks</a> for consuming results, using the <code>metadata</code> and <code>batchId</code> to match up results to the original inputs in your downstream systems. However, you can integrate in a polling mechanism by using a combination of the <a href="https://docs.extend.ai/2025-04-21/developers/api-reference/workflow-endpoints/list-workflow-runs">List Workflow Runs</a> endpoint to fetch all runs via a batch, and then <a href="https://docs.extend.ai/2025-04-21/developers/api-reference/workflow-endpoints/get-workflow-run">Get Workflow Run</a> to fetch the full outputs each run.</p>
