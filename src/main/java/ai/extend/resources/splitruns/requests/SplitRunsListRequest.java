...
public final class SplitRunsListRequest {
    ...
    /**
     * @return Filters split runs by the splitter ID. If not provided, all split runs are returned.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SplitRunsListRequest && equalTo((SplitRunsListRequest) other);
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>Filters split runs by the splitter ID. If not provided, all split runs are returned.</p>
         * <p>Example: <code>&quot;spl_BMdfq_yWM3sT-ZzvCnA3f&quot;</code></p>
         */
        @JsonSetter(value = "splitterId", nulls = Nulls.SKIP)
        public Builder splitterId(Optional<String> splitterId) {
            this.splitterId = splitterId;
            return this;
        }
