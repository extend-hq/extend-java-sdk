...
@JsonDeserialize(builder = SplitRunsCancelRequest.Builder.class)
public final class SplitRunsCancelRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private SplitRunsCancelRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SplitRunsCancelRequest && equalTo((SplitRunsCancelRequest) other);
    }
    ...
    private boolean equalTo(SplitRunsCancelRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SplitRunsCancelRequest other) {
        ...
        public SplitRunsCancelRequest build() {
            return new SplitRunsCancelRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
