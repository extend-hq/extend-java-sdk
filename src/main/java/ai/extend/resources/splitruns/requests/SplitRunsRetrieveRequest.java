...
@JsonDeserialize(builder = SplitRunsRetrieveRequest.Builder.class)
public final class SplitRunsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private SplitRunsRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SplitRunsRetrieveRequest && equalTo((SplitRunsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(SplitRunsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SplitRunsRetrieveRequest other) {
        ...
        public SplitRunsRetrieveRequest build() {
            return new SplitRunsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
