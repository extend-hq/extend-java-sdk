...
@JsonDeserialize(builder = SplitRunsDeleteRequest.Builder.class)
public final class SplitRunsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private SplitRunsDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SplitRunsDeleteRequest && equalTo((SplitRunsDeleteRequest) other);
    }
    ...
    private boolean equalTo(SplitRunsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SplitRunsDeleteRequest other) {
        ...
        public SplitRunsDeleteRequest build() {
            return new SplitRunsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
