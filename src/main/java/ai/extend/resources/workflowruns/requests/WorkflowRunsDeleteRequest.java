...
@JsonDeserialize(builder = WorkflowRunsDeleteRequest.Builder.class)
public final class WorkflowRunsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WorkflowRunsDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkflowRunsDeleteRequest && equalTo((WorkflowRunsDeleteRequest) other);
    }
    ...
    private boolean equalTo(WorkflowRunsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WorkflowRunsDeleteRequest other) {
        ...
        public WorkflowRunsDeleteRequest build() {
            return new WorkflowRunsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
