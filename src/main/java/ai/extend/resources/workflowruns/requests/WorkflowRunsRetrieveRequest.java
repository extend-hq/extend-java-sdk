...
@JsonDeserialize(builder = WorkflowRunsRetrieveRequest.Builder.class)
public final class WorkflowRunsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WorkflowRunsRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkflowRunsRetrieveRequest && equalTo((WorkflowRunsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(WorkflowRunsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WorkflowRunsRetrieveRequest other) {
        ...
        public WorkflowRunsRetrieveRequest build() {
            return new WorkflowRunsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
