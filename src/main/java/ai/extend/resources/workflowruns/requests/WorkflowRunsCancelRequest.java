...
@JsonDeserialize(builder = WorkflowRunsCancelRequest.Builder.class)
public final class WorkflowRunsCancelRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WorkflowRunsCancelRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkflowRunsCancelRequest && equalTo((WorkflowRunsCancelRequest) other);
    }
    ...
    private boolean equalTo(WorkflowRunsCancelRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WorkflowRunsCancelRequest other) {
        ...
        public WorkflowRunsCancelRequest build() {
            return new WorkflowRunsCancelRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
