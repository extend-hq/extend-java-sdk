...
@JsonDeserialize(builder = ClassifyRunsRetrieveRequest.Builder.class)
public final class ClassifyRunsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ClassifyRunsRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassifyRunsRetrieveRequest && equalTo((ClassifyRunsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(ClassifyRunsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClassifyRunsRetrieveRequest other) {
        ...
        public ClassifyRunsRetrieveRequest build() {
            return new ClassifyRunsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
