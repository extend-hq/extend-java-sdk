...
@JsonDeserialize(builder = ClassifyRunsCancelRequest.Builder.class)
public final class ClassifyRunsCancelRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ClassifyRunsCancelRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassifyRunsCancelRequest && equalTo((ClassifyRunsCancelRequest) other);
    }
    ...
    private boolean equalTo(ClassifyRunsCancelRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClassifyRunsCancelRequest other) {
        ...
        public ClassifyRunsCancelRequest build() {
            return new ClassifyRunsCancelRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
