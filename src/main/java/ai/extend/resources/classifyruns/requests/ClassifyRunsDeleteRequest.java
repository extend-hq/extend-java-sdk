...
@JsonDeserialize(builder = ClassifyRunsDeleteRequest.Builder.class)
public final class ClassifyRunsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ClassifyRunsDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassifyRunsDeleteRequest && equalTo((ClassifyRunsDeleteRequest) other);
    }
    ...
    private boolean equalTo(ClassifyRunsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClassifyRunsDeleteRequest other) {
        ...
        public ClassifyRunsDeleteRequest build() {
            return new ClassifyRunsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
