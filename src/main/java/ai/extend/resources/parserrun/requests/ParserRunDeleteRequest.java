...
@JsonDeserialize(builder = ParserRunDeleteRequest.Builder.class)
public final class ParserRunDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ParserRunDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ParserRunDeleteRequest && equalTo((ParserRunDeleteRequest) other);
    }
    ...
    private boolean equalTo(ParserRunDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ParserRunDeleteRequest other) {
        ...
        public ParserRunDeleteRequest build() {
            return new ParserRunDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
