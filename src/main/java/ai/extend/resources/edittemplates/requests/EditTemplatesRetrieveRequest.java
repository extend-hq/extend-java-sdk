 ...
 */
package ai.extend.resources.edittemplates.requests;
...
@JsonDeserialize(builder = EditTemplatesRetrieveRequest.Builder.class)
public final class EditTemplatesRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EditTemplatesRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EditTemplatesRetrieveRequest && equalTo((EditTemplatesRetrieveRequest) other);
    }
    ...
    private boolean equalTo(EditTemplatesRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EditTemplatesRetrieveRequest other) {
        ...
        public EditTemplatesRetrieveRequest build() {
            return new EditTemplatesRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
