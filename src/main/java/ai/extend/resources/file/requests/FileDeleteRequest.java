...
@JsonDeserialize(builder = FileDeleteRequest.Builder.class)
public final class FileDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private FileDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FileDeleteRequest && equalTo((FileDeleteRequest) other);
    }
    ...
    private boolean equalTo(FileDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(FileDeleteRequest other) {
        ...
        public FileDeleteRequest build() {
            return new FileDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
