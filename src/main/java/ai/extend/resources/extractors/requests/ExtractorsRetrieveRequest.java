...
@JsonDeserialize(builder = ExtractorsRetrieveRequest.Builder.class)
public final class ExtractorsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ExtractorsRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractorsRetrieveRequest && equalTo((ExtractorsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(ExtractorsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExtractorsRetrieveRequest other) {
        ...
        public ExtractorsRetrieveRequest build() {
            return new ExtractorsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
