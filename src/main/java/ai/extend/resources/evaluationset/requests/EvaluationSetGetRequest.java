...
@JsonDeserialize(builder = EvaluationSetGetRequest.Builder.class)
public final class EvaluationSetGetRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EvaluationSetGetRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EvaluationSetGetRequest && equalTo((EvaluationSetGetRequest) other);
    }
    ...
    private boolean equalTo(EvaluationSetGetRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EvaluationSetGetRequest other) {
        ...
        public EvaluationSetGetRequest build() {
            return new EvaluationSetGetRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
