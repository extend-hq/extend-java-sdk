...
@JsonDeserialize(builder = EvaluationSetItemDeleteRequest.Builder.class)
public final class EvaluationSetItemDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EvaluationSetItemDeleteRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EvaluationSetItemDeleteRequest && equalTo((EvaluationSetItemDeleteRequest) other);
    }
    ...
    private boolean equalTo(EvaluationSetItemDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EvaluationSetItemDeleteRequest other) {
        ...
        public EvaluationSetItemDeleteRequest build() {
            return new EvaluationSetItemDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
