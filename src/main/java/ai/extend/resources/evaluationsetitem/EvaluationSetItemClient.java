...
public class EvaluationSetItemClient {
     ...
     */
    public EvaluationSetItemDeleteResponse delete(String id) {
     ...
     * <p>This endpoint can be used to remove individual items from an evaluation set when they are no longer needed or if they were added in error.</p>
     */
    public EvaluationSetItemDeleteResponse delete(String id, EvaluationSetItemDeleteRequest request) {
     ...
     * <p>This endpoint can be used to remove individual items from an evaluation set when they are no longer needed or if they were added in error.</p>
     */
    public EvaluationSetItemDeleteResponse delete(
