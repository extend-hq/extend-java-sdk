...
public class AsyncRawEvaluationSetItemClient {
     ...
     */
    public CompletableFuture<ExtendClientHttpResponse<EvaluationSetItemDeleteResponse>> delete(String id) {
     ...
     * <p>This endpoint can be used to remove individual items from an evaluation set when they are no longer needed or if they were added in error.</p>
     */
    public CompletableFuture<ExtendClientHttpResponse<EvaluationSetItemDeleteResponse>> delete(
        ...
        CompletableFuture<ExtendClientHttpResponse<EvaluationSetItemDeleteResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
