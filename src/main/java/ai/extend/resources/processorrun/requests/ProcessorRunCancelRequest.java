...
@JsonDeserialize(builder = ProcessorRunCancelRequest.Builder.class)
public final class ProcessorRunCancelRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ProcessorRunCancelRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProcessorRunCancelRequest && equalTo((ProcessorRunCancelRequest) other);
    }
    ...
    private boolean equalTo(ProcessorRunCancelRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ProcessorRunCancelRequest other) {
        ...
        public ProcessorRunCancelRequest build() {
            return new ProcessorRunCancelRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
