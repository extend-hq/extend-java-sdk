...
public final class ProcessorRunCreateRequest {
    ...
    /**
     * @return The file to be processed. One of <code>file</code> or <code>rawText</code> must be provided. Supported file types can be found <a href="https://docs.extend.ai/2025-04-21/product/general/supported-file-types">here</a>.
     */
    @JsonProperty("file")
    ...
    public interface _FinalStage {
        ...
        /**
         * <p>The file to be processed. One of <code>file</code> or <code>rawText</code> must be provided. Supported file types can be found <a href="https://docs.extend.ai/2025-04-21/product/general/supported-file-types">here</a>.</p>
         */
