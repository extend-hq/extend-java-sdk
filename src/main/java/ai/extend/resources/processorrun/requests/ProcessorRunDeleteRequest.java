...
@JsonDeserialize(builder = ProcessorRunDeleteRequest.Builder.class)
public final class ProcessorRunDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ProcessorRunDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProcessorRunDeleteRequest && equalTo((ProcessorRunDeleteRequest) other);
    }
    ...
    private boolean equalTo(ProcessorRunDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ProcessorRunDeleteRequest other) {
        ...
        public ProcessorRunDeleteRequest build() {
            return new ProcessorRunDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
