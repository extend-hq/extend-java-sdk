...
@JsonDeserialize(builder = ProcessorRunGetRequest.Builder.class)
public final class ProcessorRunGetRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ProcessorRunGetRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProcessorRunGetRequest && equalTo((ProcessorRunGetRequest) other);
    }
    ...
    private boolean equalTo(ProcessorRunGetRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ProcessorRunGetRequest other) {
        ...
        public ProcessorRunGetRequest build() {
            return new ProcessorRunGetRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
