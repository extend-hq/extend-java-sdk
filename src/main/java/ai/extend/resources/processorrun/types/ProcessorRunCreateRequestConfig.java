...
public final class ProcessorRunCreateRequestConfig {
    ...
    public static ProcessorRunCreateRequestConfig classify(LegacyClassificationConfig value) {
        return new ProcessorRunCreateRequestConfig(new ClassifyValue(value));
    }

    public static ProcessorRunCreateRequestConfig extract(LegacyExtractionConfig value) {
        return new ProcessorRunCreateRequestConfig(new ExtractValue(value));
    }

    public static ProcessorRunCreateRequestConfig splitter(LegacySplitterConfig value) {
