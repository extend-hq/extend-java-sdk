 ...
 */
package ai.extend.resources.workflowversions.requests;
...
@JsonDeserialize(builder = WorkflowVersionsListRequest.Builder.class)
public final class WorkflowVersionsListRequest {
    ...
    private WorkflowVersionsListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkflowVersionsListRequest && equalTo((WorkflowVersionsListRequest) other);
    }
    ...
    private boolean equalTo(WorkflowVersionsListRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.nextPageToken, this.maxPageSize, this.sortDir);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(WorkflowVersionsListRequest other) {
        ...
        public WorkflowVersionsListRequest build() {
            return new WorkflowVersionsListRequest(nextPageToken, maxPageSize, sortDir, additionalProperties);
        }
    }
}
