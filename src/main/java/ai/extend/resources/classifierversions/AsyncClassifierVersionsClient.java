...
public class AsyncClassifierVersionsClient {
    ...
    private final AsyncRawClassifierVersionsClient rawClient;

    public AsyncClassifierVersionsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new AsyncRawClassifierVersionsClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public AsyncRawClassifierVersionsClient withRawResponse() {
     ...
     */
    public CompletableFuture<ClassifierVersionsListResponse> list(String classifierId) {
        return this.rawClient.list(classifierId).thenApply(response -> response.body());
    }
     ...
     * <p>Versions are returned in descending order of creation (newest first) with the <code>draft</code> version first. The <code>draft</code> version is the latest unpublished version of the classifier, which can be published to create a new version. It might not have any changes from the last published version.</p>
     */
    public CompletableFuture<ClassifierVersionsListResponse> list(String classifierId, RequestOptions requestOptions) {
        return this.rawClient.list(classifierId, requestOptions).thenApply(response -> response.body());
    }
     ...
     * <p>Versions are returned in descending order of creation (newest first) with the <code>draft</code> version first. The <code>draft</code> version is the latest unpublished version of the classifier, which can be published to create a new version. It might not have any changes from the last published version.</p>
     */
    public CompletableFuture<ClassifierVersionsListResponse> list(
            String classifierId, ClassifierVersionsListRequest request) {
        return this.rawClient.list(classifierId, request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<ClassifierVersionsListResponse> list(
        ...
        return this.rawClient.list(classifierId, request, requestOptions).thenApply(response -> response.body());
    }
     ...
     */
    public CompletableFuture<ClassifierVersion> create(String classifierId, ClassifierVersionsCreateRequest request) {
        return this.rawClient.create(classifierId, request).thenApply(response -> response.body());
    }
     ...
     * <p>Publishing a new version does not automatically update existing workflows using this classifier. You may need to manually update workflows to use the new version if desired.</p>
     */
    public CompletableFuture<ClassifierVersion> create(
            String classifierId, ClassifierVersionsCreateRequest request, RequestOptions requestOptions) {
        return this.rawClient.create(classifierId, request, requestOptions).thenApply(response -> response.body());
    }

    /**
     * Retrieve a specific version of a classifier in Extend
     */
    public CompletableFuture<ClassifierVersion> retrieve(String classifierId, String versionId) {
        return this.rawClient.retrieve(classifierId, versionId).thenApply(response -> response.body());
    }
