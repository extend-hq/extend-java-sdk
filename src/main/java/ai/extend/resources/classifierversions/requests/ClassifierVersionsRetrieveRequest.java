...
@JsonDeserialize(builder = ClassifierVersionsRetrieveRequest.Builder.class)
public final class ClassifierVersionsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ClassifierVersionsRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassifierVersionsRetrieveRequest && equalTo((ClassifierVersionsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(ClassifierVersionsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClassifierVersionsRetrieveRequest other) {
        ...
        public ClassifierVersionsRetrieveRequest build() {
            return new ClassifierVersionsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
