...
@JsonDeserialize(builder = ClassifiersListRequest.Builder.class)
public final class ClassifiersListRequest {
    ...
    private ClassifiersListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassifiersListRequest && equalTo((ClassifiersListRequest) other);
    }
    ...
    private boolean equalTo(ClassifiersListRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClassifiersListRequest other) {
        ...
        public ClassifiersListRequest build() {
            return new ClassifiersListRequest(nextPageToken, maxPageSize, sortBy, sortDir, additionalProperties);
        }
    }
}
