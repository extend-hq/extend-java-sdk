...
@JsonDeserialize(builder = ClassifiersRetrieveRequest.Builder.class)
public final class ClassifiersRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ClassifiersRetrieveRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassifiersRetrieveRequest && equalTo((ClassifiersRetrieveRequest) other);
    }
    ...
    private boolean equalTo(ClassifiersRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClassifiersRetrieveRequest other) {
        ...
        public ClassifiersRetrieveRequest build() {
            return new ClassifiersRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
