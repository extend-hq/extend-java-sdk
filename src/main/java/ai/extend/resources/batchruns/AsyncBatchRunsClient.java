...
public class AsyncBatchRunsClient {
    protected final ClientOptions clientOptions;

    private final AsyncRawBatchRunsClient rawClient;

    public AsyncBatchRunsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new AsyncRawBatchRunsClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public AsyncRawBatchRunsClient withRawResponse() {
     ...
     * </ul>
     */
    public CompletableFuture<BatchRun> get(String id) {
     ...
     * </ul>
     */
    public CompletableFuture<BatchRun> get(String id, RequestOptions requestOptions) {
