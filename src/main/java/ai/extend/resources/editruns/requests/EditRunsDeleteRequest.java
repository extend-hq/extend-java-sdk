...
@JsonDeserialize(builder = EditRunsDeleteRequest.Builder.class)
public final class EditRunsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private EditRunsDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EditRunsDeleteRequest && equalTo((EditRunsDeleteRequest) other);
    }
    ...
    private boolean equalTo(EditRunsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EditRunsDeleteRequest other) {
        ...
        public EditRunsDeleteRequest build() {
            return new EditRunsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
