...
@JsonDeserialize(builder = SplitterVersionsRetrieveRequest.Builder.class)
public final class SplitterVersionsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private SplitterVersionsRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SplitterVersionsRetrieveRequest && equalTo((SplitterVersionsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(SplitterVersionsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SplitterVersionsRetrieveRequest other) {
        ...
        public SplitterVersionsRetrieveRequest build() {
            return new SplitterVersionsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
