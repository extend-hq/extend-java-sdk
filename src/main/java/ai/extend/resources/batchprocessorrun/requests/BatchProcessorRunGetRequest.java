 ...
 */
package ai.extend.resources.batchprocessorrun.requests;
...
@JsonDeserialize(builder = BatchProcessorRunGetRequest.Builder.class)
public final class BatchProcessorRunGetRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private BatchProcessorRunGetRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BatchProcessorRunGetRequest && equalTo((BatchProcessorRunGetRequest) other);
    }
    ...
    private boolean equalTo(BatchProcessorRunGetRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BatchProcessorRunGetRequest other) {
        ...
        public BatchProcessorRunGetRequest build() {
            return new BatchProcessorRunGetRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
