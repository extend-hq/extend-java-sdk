...
public class AsyncParseRunsClient {
    protected final ClientOptions clientOptions;

    private final AsyncRawParseRunsClient rawClient;

    public AsyncParseRunsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new AsyncRawParseRunsClient(clientOptions);
    }
     ...
     */
    public CompletableFuture<ParseRun> create(ParseRunsCreateRequest request) {
     ...
     * <p>The request returns immediately with a <code>PROCESSING</code> status. Use webhooks or poll the Get Parse Run endpoint for results.</p>
     */
    public CompletableFuture<ParseRun> create(ParseRunsCreateRequest request, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<ParseRunsDeleteResponse> delete(String id) {
     ...
     * <p>This endpoint can be used if you'd like to manage data retention on your own rather than automated data retention policies. Or make one-off deletions for your downstream customers.</p>
     */
    public CompletableFuture<ParseRunsDeleteResponse> delete(String id, RequestOptions requestOptions) {
     ...
     * <p>This endpoint can be used if you'd like to manage data retention on your own rather than automated data retention policies. Or make one-off deletions for your downstream customers.</p>
     */
    public CompletableFuture<ParseRunsDeleteResponse> delete(String id, ParseRunsDeleteRequest request) {
