...
@JsonDeserialize(builder = ParseRunsCancelRequest.Builder.class)
public final class ParseRunsCancelRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ParseRunsCancelRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ParseRunsCancelRequest && equalTo((ParseRunsCancelRequest) other);
    }
    ...
    private boolean equalTo(ParseRunsCancelRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ParseRunsCancelRequest other) {
        ...
        public ParseRunsCancelRequest build() {
            return new ParseRunsCancelRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
