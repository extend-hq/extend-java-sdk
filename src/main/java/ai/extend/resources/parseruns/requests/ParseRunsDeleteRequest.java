...
@JsonDeserialize(builder = ParseRunsDeleteRequest.Builder.class)
public final class ParseRunsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ParseRunsDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ParseRunsDeleteRequest && equalTo((ParseRunsDeleteRequest) other);
    }
    ...
    private boolean equalTo(ParseRunsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ParseRunsDeleteRequest other) {
        ...
        public ParseRunsDeleteRequest build() {
            return new ParseRunsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
