...
public final class ParseRunsListResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ParseRunsListResponse && equalTo((ParseRunsListResponse) other);
    }
    ...
    private boolean equalTo(ParseRunsListResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ParseRunsListResponse other) {
            data(other.getData());
        ...
        public ParseRunsListResponse build() {
            return new ParseRunsListResponse(data, nextPageToken, additionalProperties);
        }
    }
}
