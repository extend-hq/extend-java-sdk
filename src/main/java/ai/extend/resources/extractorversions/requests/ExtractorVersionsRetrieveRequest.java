...
@JsonDeserialize(builder = ExtractorVersionsRetrieveRequest.Builder.class)
public final class ExtractorVersionsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private ExtractorVersionsRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExtractorVersionsRetrieveRequest && equalTo((ExtractorVersionsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(ExtractorVersionsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ExtractorVersionsRetrieveRequest other) {
        ...
        public ExtractorVersionsRetrieveRequest build() {
            return new ExtractorVersionsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
