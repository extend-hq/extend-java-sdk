...
public class ExtractorVersionsClient {
    protected final ClientOptions clientOptions;

    private final RawExtractorVersionsClient rawClient;

    public ExtractorVersionsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new RawExtractorVersionsClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public RawExtractorVersionsClient withRawResponse() {
     ...
     */
    public ExtractorVersionsListResponse list(String extractorId) {
        return this.rawClient.list(extractorId).body();
    }
     ...
     * <p>Versions are returned in descending order of creation (newest first) with the <code>draft</code> version first. The <code>draft</code> version is the latest unpublished version of the extractor, which can be published to create a new version. It might not have any changes from the last published version.</p>
     */
    public ExtractorVersionsListResponse list(String extractorId, RequestOptions requestOptions) {
        return this.rawClient.list(extractorId, requestOptions).body();
    }
     ...
     * <p>Versions are returned in descending order of creation (newest first) with the <code>draft</code> version first. The <code>draft</code> version is the latest unpublished version of the extractor, which can be published to create a new version. It might not have any changes from the last published version.</p>
     */
    public ExtractorVersionsListResponse list(String extractorId, ExtractorVersionsListRequest request) {
        return this.rawClient.list(extractorId, request).body();
    }
     ...
     * <p>Versions are returned in descending order of creation (newest first) with the <code>draft</code> version first. The <code>draft</code> version is the latest unpublished version of the extractor, which can be published to create a new version. It might not have any changes from the last published version.</p>
     */
    public ExtractorVersionsListResponse list(
            String extractorId, ExtractorVersionsListRequest request, RequestOptions requestOptions) {
        return this.rawClient.list(extractorId, request, requestOptions).body();
    }
     ...
     */
    public ExtractorVersion create(String extractorId, ExtractorVersionsCreateRequest request) {
        return this.rawClient.create(extractorId, request).body();
    }
     ...
     * <p>Publishing a new version does not automatically update existing workflows using this extractor. You may need to manually update workflows to use the new version if desired.</p>
     */
    public ExtractorVersion create(
            String extractorId, ExtractorVersionsCreateRequest request, RequestOptions requestOptions) {
        return this.rawClient.create(extractorId, request, requestOptions).body();
    }

    /**
     * Retrieve a specific version of an extractor in Extend
     */
    public ExtractorVersion retrieve(String extractorId, String versionId) {
        return this.rawClient.retrieve(extractorId, versionId).body();
    }
