...
@JsonDeserialize(builder = FilesDeleteRequest.Builder.class)
public final class FilesDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private FilesDeleteRequest(Optional<String> extendWorkspaceId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FilesDeleteRequest && equalTo((FilesDeleteRequest) other);
    }
    ...
    private boolean equalTo(FilesDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(FilesDeleteRequest other) {
        ...
        public FilesDeleteRequest build() {
            return new FilesDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
