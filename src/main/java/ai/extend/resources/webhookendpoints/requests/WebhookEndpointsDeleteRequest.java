...
@JsonDeserialize(builder = WebhookEndpointsDeleteRequest.Builder.class)
public final class WebhookEndpointsDeleteRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WebhookEndpointsDeleteRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WebhookEndpointsDeleteRequest && equalTo((WebhookEndpointsDeleteRequest) other);
    }
    ...
    private boolean equalTo(WebhookEndpointsDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WebhookEndpointsDeleteRequest other) {
        ...
        public WebhookEndpointsDeleteRequest build() {
            return new WebhookEndpointsDeleteRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
