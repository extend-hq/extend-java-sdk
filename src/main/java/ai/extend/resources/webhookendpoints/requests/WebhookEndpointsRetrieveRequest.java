...
@JsonDeserialize(builder = WebhookEndpointsRetrieveRequest.Builder.class)
public final class WebhookEndpointsRetrieveRequest {
    private final Optional<String> extendWorkspaceId;

    private final Map<String, Object> additionalProperties;

    private WebhookEndpointsRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WebhookEndpointsRetrieveRequest && equalTo((WebhookEndpointsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(WebhookEndpointsRetrieveRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(WebhookEndpointsRetrieveRequest other) {
        ...
        public WebhookEndpointsRetrieveRequest build() {
            return new WebhookEndpointsRetrieveRequest(extendWorkspaceId, additionalProperties);
        }
    }
}
